...
def get_db_connection():
    if 'active_connection_count' not in global_vars:
        global_vars['active_connection_count'] = 0
    global_vars['active_connection_count'] = global_vars['active_connection_count'] + 1
